...
float calculate_super_power(unsigned long int population, float area, float pib, int attractions, float pib_per_capita, float density) {
    return population + area + pib + attractions + pib_per_capita + (1000000.0f / density);
}
...
int main() {
  ...
  float card_1_area, card_2_area, card_1_pib, card_2_pib, card_1_density, card_2_density, card_1_pib_capita, card_2_pib_capita, card_1_super_power, card_2_super_power;
  ...
  card_1_super_power = calculate_super_power(card_1_population, card_1_area, card_1_pib, card_1_tourist_attractions, card_1_pib_capita, card_1_density);
  ...
  card_2_super_power = calculate_super_power(card_2_population, card_2_area, card_2_pib, card_2_tourist_attractions, card_2_pib_capita, card_2_density);
  ...
  comparison_result = card_1_pib > card_2_pib;
  winner_card = 2 - comparison_result;
  ...
  comparison_result = card_1_pib_capita > card_2_pib_capita;
  winner_card = 2 - comparison_result;
